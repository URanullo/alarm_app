...
export default function SOSScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Bottom Navigation (Home and Profile only) */}
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/profile')}>
          <Ionicons name="person-outline" size={24} color="#bbb" />
...
const styles = StyleSheet.create({
  ...
  bottomNav: {
    ...
    paddingVertical: 10,
    position: 'absolute', // Ensure the bar floats
    bottom: 44, // A little above the phone's gesture area
    left: 0,
    right: 0,
    shadowColor: '#000',
    shadowOffset: { width: 0, height: -2 },
